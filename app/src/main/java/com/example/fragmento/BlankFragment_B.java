...
public class BlankFragment_B extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_blank__b, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // ler o bundle
        Bundle recebeBundle = this.getArguments();

        ((TextView) view.findViewById(R.id.saida)).setText(recebeBundle.getString("texto"));
    }
}